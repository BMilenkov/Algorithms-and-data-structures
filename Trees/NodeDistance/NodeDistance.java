package Trees.NodeDistance;


import Trees.BinaryTreeSum.BNode;
import Trees.BinaryTreeSum.BTree;
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (i = 0; i < N; i++) {
            ...
            if (action.equals("LEFT")) {
                tree.addChildNode(nodes[Integer.parseInt(st.nextToken())], Trees.NodeDistance.BNode.LEFT, nodes[index]);
            } else if (action.equals("RIGHT")) {
                tree.addChildNode(nodes[Integer.parseInt(st.nextToken())], Trees.NodeDistance.BNode.RIGHT, nodes[index]);
            } else {
