...
public class JoinSorteedLists<E extends Comparable<E>> {

    public MySLL<E> join(MySLL<E> list1, MySLL<E> list2) {
        MySLL<E> finalList = new MySLL<E>();
        SLLNode<E> j1 = list1.first;
        SLLNode<E> j2 = list2.first;
    ...
    public static void main(String[] args) {
        ...
        JoinSorteedLists<String> js = new JoinSorteedLists<String>();
